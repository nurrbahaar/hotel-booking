...
const HotelCard = ({ room, index }) => {
    return (
        <Link to={'/rooms/' + room._id} onClick={() => window.scrollTo(0, 0)} key={room._id}
            ...
            <img src={room.images[0]} alt="" className='relative max-v-70 w-full rounded-xl  overflow-hidden bg-white text-gray500/90 shadow[0px_4px_4px_rgba(0,0,0,0,05)]' />
            ...
            <div className='p-4 pt-5'>
                ...
                <div className='flex items-center justify-between'>
                    <p>
                        <span>${room.pricePerNigh} </span> / night
                    </p>
