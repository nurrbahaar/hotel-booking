...
const Hero = () => {
    return (
        <div
            ...
            <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mt-20'>Otel Deneyimi </p>
            <h1 className='font-playfair text-2xl md:text-5xl md:text-[56px] md:leading-[56px] font-bold md:font-extrabold max-w-xl mt-4'>Roomy en iyi otel deneyimi</h1>
            ...
            <form className='bg-white text-gray-500 rounded-lg px-6 py-4  mt-8 flex flex-col md:flex-row max-md:items-start gap-4 max-md:mx-auto'>
                ...
                <div className='flex md:flex-col max-md:gap-2 max-md:items-center'>
                    <label htmlFor="guests">Konuklar</label>
